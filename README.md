...
A [re-frame](https://github.com/day8/re-frame) application designed to be able to play 15 puzzle
you.
...
* [`src/pz15/`](src/pz15/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/pz15/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `pz15` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/pz15/config.cljs) defaults to `true` in
